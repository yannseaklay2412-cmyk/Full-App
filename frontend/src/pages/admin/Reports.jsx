...
export default function Reports() {
  ...
  return (
    <AdminLayout pageLabel="Reports & Settings" topBarRight={topBarRight}>

      {/* TOP STAT CARDS */}
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 16, marginBottom: 24 }}>
        {[
          { label: 'Total Bookings',  num: stats.totalBookings, color: '#7c3aed', icon: '\u{1F4C5}' },
          { label: 'Total Patients',  num: stats.totalPatients, color: '#4ecdc4', icon: '\u{1F464}' },
          { label: 'Total Dentists',  num: stats.totalDentists, color: '#f5c842', icon: '\u{1F9B7}' },
          { label: 'Today\'s Visits', num: stats.todayBookings, color: '#ff6b6b', icon: '\u{1F4C6}' },
        ].map((s, i) => (
