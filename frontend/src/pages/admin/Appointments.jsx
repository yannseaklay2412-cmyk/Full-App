...
export default function Appointments() {
  ...
  return (
    <AdminLayout pageLabel="Appointment" topBarRight={topBarRight}>
          ...
          <tbody>
            {filtered.length === 0 ? (
              ...
              <tr key={b.id} style={{ borderBottom: '1px solid #f0f2f5', transition: 'background 0.15s' }}
                ...
                <td style={{ padding: '13px 16px' }}>
                  <span style={{ padding: '4px 12px', borderRadius: 99, border: `1px solid ${STATUS_COLORS[b.status] || '#8a9fc4'}`, color: STATUS_COLORS[b.status] || '#8a9fc4', fontSize: 11, fontWeight: 600 }}>
                    {b.status}
                  </span>
                </td>
                <td style={{ padding: '13px 16px' }}>
