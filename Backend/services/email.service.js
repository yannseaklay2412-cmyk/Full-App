...
export const sendPasswordConfirmEmail = async (toEmail, resetLink) => {
  const info = await transporter.sendMail({
    from: '"ToothTime" <admin253213@gmail.com>',
    to: toEmail,
    subject: 'Reset your password – ToothTime',
    html: `
      <div style="font-family: 'Segoe UI', sans-serif; max-width: 480px; margin: 0 auto; padding: 32px; border: 1px solid #e5e7eb; border-radius: 12px;">
        ...
        <h3 style="color: #1e1e1e; margin-bottom: 16px;">Reset Your Password</h3>
